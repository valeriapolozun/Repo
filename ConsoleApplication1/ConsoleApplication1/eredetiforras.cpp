...
void readData (vector<Coordinates> & basicData,double &LMax, double &tMax)
{
	Coordinates c;
	char line [80];

	ifstream file ("set_64_1_50_300.txt"); //open file
...
void calcDistanceMatrix (vector<Coordinates> basicData,double distanceMatrix[problemSize][problemSize])
{
...
int main(int argc, char **argv) {
	...
	double tMax; // max time allowed for travel
	double LMax; // load max
	vector<Coordinates> basicData;

	readData (basicData,LMax, tMax);
